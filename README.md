...
3. `vendor/xmllint-wasm/` — vendored WASM build (~800 KB total, vs multi‑MB Pyodide previously)
...
|------|-----------------|-----|
| [`examples/valid-bimi.svg`](examples/valid-bimi.svg) | Pass | `version="1.2"`, `baseProfile="tiny-ps"`, `viewBox`, only allowed shapes/text |
